  ...
  computed: {
    ...
    links(){
      return  [
        ...
        { title: 'Boxes', href: `.${this.$store.state.currentTh2Version.path}boxes`, icon: 'mdi-package-variant-closed',
