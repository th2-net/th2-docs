...
Once all the required software is installed on your th2 node, Apache Cassandra node, operator box, and th2-infra repositorie is ready, you can start configuring the cluster.
