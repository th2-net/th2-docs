...
Next components of monitoring stack are deployed into _monitoring_ namespace:
...
Set `infraMgr.git.repository` value in the [service.values.yaml](./example-values/service.values.yaml) file to **https** link of your schema repository. 
