...
This table contains the list of Technologies and their versions which are required to work with th2. Installation instructions are given in [Installation](/deploy/getting-started/install-th2/1-base-system/) section. 
